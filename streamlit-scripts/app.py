...
if st.session_state.dashboard == "old":
    ...
    match_compare_page = st.Page("pages_new/match_compare.py", title="Match Compare", icon="⚖️")
    ...
    pg = st.navigation(
        {
            ...
            "Analytics": [score_explorer_page, pref_photo_search_page, user_reco_action_page],
        }
    )
    pg.run()
